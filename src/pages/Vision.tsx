          ...
          <Card className="border-2 border-primary/20 shadow-card">
            <CardContent className="p-8 md:p-12 space-y-6 text-lg leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Young minds are nurtured and equipped with skills that shape their future</li>
                <li>The vulnerable and marginalized find support, dignity, and hope</li>
                <li>Healthcare is accessible to those who need it most</li>
                <li>Economic empowerment breaks the cycle of poverty</li>
                <li>Knowledge and opportunity flow freely across all barriers</li>
              </ul>
              <p>
