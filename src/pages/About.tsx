      ...
      <section className="py-16 bg-gradient-warm text-primary-foreground">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-xl opacity-95 leading-relaxed mb-8">
            Whether through donations, volunteering, or partnership, there are many ways you can 
            contribute to our cause and help us create lasting change in communities that need it most.
          </p>
        </div>
      </section>
